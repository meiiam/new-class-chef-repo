...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "meiiam-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/devopsclass"
  #   chef.validation_client_name = "devopsclass-validator"
  #   chef.validation_key_path = ".chef/devopsclass-validator.pem"
  # end
end
